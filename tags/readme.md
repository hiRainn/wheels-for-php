...
![init_1 png](./md_images/init_1.png)
![init_2 png](./md_images/init_2.png)

<h5 id="add">增加标签</h5>
按逗号与回车会添加新的标签，当标签已存在或者已经达到最大标签数时，会提示错误信息。
![exists png](./md_images/exists.png)
![overstep png](./md_images/overstep.png)
当输入值返回有存在信息时，按↑与↓时可以选择已存在的标签，同时点击鼠标选择内容也可以选择标签
![up png](./md_images/up_down.png)
![mouse png](./md_images/mouse.png)
...
![delete png](./md_images/delete.png)
